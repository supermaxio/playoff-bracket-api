...
func EspnTeamRecord(teamId string) (types.EspnTeamRecord, error) {
	...
	resp, err := ApiGetRequest(fmt.Sprintf("http://sports.core.api.espn.com/v2/sports/football/leagues/nfl/seasons/2025/types/2/teams/%s/record?lang=en&region=us", teamId))
	if err != nil {
